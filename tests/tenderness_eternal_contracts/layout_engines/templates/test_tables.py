...
MINIMAL_FLEXBOX_TEMPLATE_TABLES_TEST_CLASS_CONFIG = [
    ClassTestConfig(
        ...
        expected_methods=MINIMAL_FLEXBOX_TEMPLATE_TABLES_EXPECTED_METHODS,
    )
]


@pytest.mark.parametrize("config", MINIMAL_FLEXBOX_TEMPLATE_TABLES_TEST_CLASS_CONFIG, ids=lambda c: c.cls.__name__)
class TestMinimalFlexBoxTemplateTablesEternalContract(ClassTestBase):
    pass
