...
from tenderness.pipelines.document.text_block_helpers import TextBlock, TextStyle
...
ONLY_TEXTBLOCKS_TEST_CASES: list[DocumentRenderPipelineTestCase] = [
    DocumentRenderPipelineTestCase(
    ...
    DocumentRenderPipelineTestCase(
        ...
        blocks_config=DocumentBlocksConfig(
            surface_config=_DEFAULT_PLACEHOLDER_SURFACE_CONFIG,
            blocks=[
                TextBlock(text="Column 1: The quick brown fox jumps over the lazy dog."),
                TextBlock(text="Column 2: The quick brown fox jumps over the lazy dog."),
                TextBlock(text="Column 3: The quick brown fox jumps over the lazy dog."),
            ],
    ...
    DocumentRenderPipelineTestCase(
        ...
        blocks_config=DocumentBlocksConfig(
            ...
            blocks=[
                ...
                TextBlock(
                    text_style=TextStyle(layout_interface_params=LayoutInterfaceParameters(justify_last_line=False)),
                ),
            ],
            base_text_style=TextStyle(
                font_description_params=FontDescriptionInterfaceParameters(family=NOTO_SANS_FONT_NAME, size=18),
