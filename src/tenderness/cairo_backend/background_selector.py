...
"""Cairo background painting utilities."""
...
class BackgroundSelector:
    """Paints a background color pattern onto a cairo context."""

    def add_background_color(
        self,
        cairo_context: cairo.Context[cairo.Surface],
        surface_config: SurfaceConfig,
        background_color_spec: PatternColorSpec,
    ) -> None:
        """Paint a background color pattern onto the full surface.
        ...
        background_color_spec
            Color specification for the background.
        """
        cairo_context.save()
        pattern = ColorPattern.create_color_pattern(background_color_spec, surface_config.color_model)
